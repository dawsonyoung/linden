...
- PR titles and bodies follow the standard in `docs/branching-strategy.md`. The body template is `.github/pull_request_template.md`; every section is required and unused sections say `N/A` with a reason.
